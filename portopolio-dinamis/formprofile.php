...
<html lang="en">
  <head>
    ...
    <body>
      ...
      <div class="container">
            <h3 style=" margin-top:90px;">Form Edit Data Profile</h2>
            <hr>
            <div class="card">
            <form action="editprofil.php" method="POST">
                <div class="card-body">
                      ...
                      <div class="mb-2">
                        ...
                        <input type="text" class="form-control" name="job" value="<?php echo $profil['job']?>">
                      </div>
                      <button class="btn mt-2 mb-2 btn-outline-primary" style="width: 20%;" name="editp" value="edit">Ubah Data</button>
                </div>
                </form>
